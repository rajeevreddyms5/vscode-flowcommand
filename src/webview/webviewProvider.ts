...
export class TaskSyncWebviewProvider implements vscode.WebviewViewProvider, vscode.Disposable {
    ...
    private _broadcastCallback: ((message: ToWebviewMessage) => void) | null = null;
     ...
     */
    public setBroadcastCallback(callback: ((message: ToWebviewMessage) => void) | null): void {
     ...
     */
    public onProcessingStateChange(callback: (isProcessing: boolean) => void): void {
